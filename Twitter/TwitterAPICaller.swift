...
import UIKit
import BDBAuthenticator


class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "kLy8krf9uqSKbwxgTeGXynIjY", consumerSecret: "pCF66UkFoOShP2NslR8PoIPVhfBJb5RTOhrotM5BUNeFWs7a86")
    var loginSuccess: (() -> ())?
